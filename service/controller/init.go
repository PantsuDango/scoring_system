...
func init() {
	...
	HandlerMap = map[string]Handler{
		"Controller.ListUser":   Controller.ListUser,
		"Controller.AddProject": Controller.AddProject,
	}
}
...
func createToken(auth string) (string, error) {
	...
	Controller := new(Controller)
	user, err := Controller.ScoringDB.QueryUserById(userID)
	if err != nil {
		return "", err
	}
...
func parseToken(token string) (*jwt.StandardClaims, error) {
	...
	u, _ := db.ScoringDB{}.QueryUserById(int(operator_id))
